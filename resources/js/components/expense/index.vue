<template>
  ...
  <br>
    <input type="text" v-model="searchTerm" class="form-control" style="width:300px;" placeholder="Search expense">
  <br>
                ...
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                      <tr>
                        <th class="col-lg-3">Expense Details</th>
                        <th class="col-lg-3">Expense Amount</th>
                        <th class="col-lg-3">Expense Date</th>
